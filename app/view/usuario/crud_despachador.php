...
if (isset($_REQUEST['p']))
{
    ...
    echo'</div>';
            ...
            //ID_USUARIO 	NOMBRE 	APELLIDO 	IDENTIFICACION 	PASSWORD 	CELULAR 	CORREO_ELECTRONICO 	CODIGO_DE_BARRAS 	ID_ROL 	ID_ALIADOS
              $arreglo = $controlusuario2->listardespachadores();
            while ($row = mysqli_fetch_row($arreglo))
              {
                 echo'<tr class="even pointer">
                      ...
                      <td>
                        ...
                        <a onclick="javascript:return confirm('¿Desea eliminar este despachador?');" href="?d=<?php echo $row[0]; ?>">Eliminar</a>
...
echo'                </tbody>
                                ...
                                <div class="well well-sm text-center">
                                    <a class="btn btn-primary" href="?c=1">Nuevo Despachador</a>
                                    </div>
                            </div>
                        </div>
