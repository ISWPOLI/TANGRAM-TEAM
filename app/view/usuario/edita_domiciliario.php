                                ...
                                <div class="x_content">
                                    ...
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" role=form method="post" action="domiciliarios.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="last-name" name = "celular" required class="form-control col-md-7 col-xs-12" value="'.$usercontrolller->model->getCELULAR().'">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                {
                                                    echo'<option ';
                                                    if ($usercontrolller->model->getID_ALIADOS() == $row[0] )
                                                    {
                                                        echo  ' selected ';
                                                    }
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                <button type="submit" name = "botoneditar" class="btn btn-success" value = "2" >editar domiciliario</button>
